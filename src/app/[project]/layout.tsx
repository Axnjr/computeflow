...
import { initDash, getVMSpecs } from '@/lib/server-utils';
...
export default async function ProjectDashLayout({ params, children }: { params: { project: string }, children: React.ReactNode }) {

    const project = await initDash(params)
    const userPlan = getVMSpecs(project.instance_metadata?.instanceType as string)
                ...
                <div className='ml-[16.666667%] w-[83.334%] '>
                    ...
                    <div className='flex items-center justify-between px-8 py-4 mb-4'>
                        ...
                        <div>
                            ...
                            <h1 className='text-base font-bold'>{userPlan?.cpu}</h1>
                        </div>
                        <div>
                            <p className='text-xs uppercase text-neutral-500'>RAM</p>
                            <h1 className='text-base font-bold'>{userPlan?.ram}</h1>
                        </div>
                        <div>
