            ...
            <DrawerContent className="text-black dark:text-white px-24 h-[60vh]">
                <DrawerHeader className="m-4">
                    ...
                    <section className="flex w-full items-center justify-between gap-4 mt-8">
                        <Link href="/new/git" className="w-1/2 h-32 border-2 dark:border-neutral-800 border-neutral-200 rounded-xl p-5 shadow-sm shadow-slate-500">
                        ...
                        <Link href="/new/docker" className="w-1/2 h-32 border-2 dark:border-neutral-800 border-neutral-200 rounded-xl p-5 shadow-sm shadow-slate-500">
                            <h1 className="text-lg tracking-tight whitespace-nowrap flex items-center leading-10">
